  ...
  return (
    <div className="w-full bg-secondary rounded px-4 py-3">
      <div className="relative w-full aspect-square flex items-center justify-center bg-background rounded p-1.5">
        ...
        <text x="50" y="91" textAnchor="middle" className="text-[9px] fill-muted-foreground font-mono">0.5</text>
        ...
        <text x="82" y="91" textAnchor="middle" className="text-[9px] fill-muted-foreground font-mono">1.0</text>
